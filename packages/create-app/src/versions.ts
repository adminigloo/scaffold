...
const PACKAGE_VERSIONS: Readonly<Record<string, string>> = {
  ...
  // + page-doc + pending-action tables); 0.2.1-0.2.2 hardened it; 0.3.x knowledge retrieval; 0.4.0 write-action confirm flow; 0.5.0 retention + erasure — valid history
